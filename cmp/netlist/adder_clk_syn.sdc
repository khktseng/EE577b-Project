...
# Created by write_sdc on Thu Apr 28 18:53:49 2022
...
set_max_delay 5  -from [list [get_ports clk] [get_ports reset] [get_ports {op1[0]}] [get_ports \
{op1[1]}] [get_ports {op1[2]}] [get_ports {op1[3]}] [get_ports {op1[4]}]       \
[get_ports {op1[5]}] [get_ports {op1[6]}] [get_ports {op1[7]}] [get_ports      \
{op1[8]}] [get_ports {op1[9]}] [get_ports {op1[10]}] [get_ports {op1[11]}]     \
[get_ports {op1[12]}] [get_ports {op1[13]}] [get_ports {op1[14]}] [get_ports   \
{op1[15]}] [get_ports {op1[16]}] [get_ports {op1[17]}] [get_ports {op1[18]}]   \
[get_ports {op1[19]}] [get_ports {op1[20]}] [get_ports {op1[21]}] [get_ports   \
{op1[22]}] [get_ports {op1[23]}] [get_ports {op1[24]}] [get_ports {op1[25]}]   \
[get_ports {op1[26]}] [get_ports {op1[27]}] [get_ports {op1[28]}] [get_ports   \
{op1[29]}] [get_ports {op1[30]}] [get_ports {op1[31]}] [get_ports {op1[32]}]   \
[get_ports {op1[33]}] [get_ports {op1[34]}] [get_ports {op1[35]}] [get_ports   \
{op1[36]}] [get_ports {op1[37]}] [get_ports {op1[38]}] [get_ports {op1[39]}]   \
[get_ports {op1[40]}] [get_ports {op1[41]}] [get_ports {op1[42]}] [get_ports   \
{op1[43]}] [get_ports {op1[44]}] [get_ports {op1[45]}] [get_ports {op1[46]}]   \
[get_ports {op1[47]}] [get_ports {op1[48]}] [get_ports {op1[49]}] [get_ports   \
{op1[50]}] [get_ports {op1[51]}] [get_ports {op1[52]}] [get_ports {op1[53]}]   \
[get_ports {op1[54]}] [get_ports {op1[55]}] [get_ports {op1[56]}] [get_ports   \
{op1[57]}] [get_ports {op1[58]}] [get_ports {op1[59]}] [get_ports {op1[60]}]   \
[get_ports {op1[61]}] [get_ports {op1[62]}] [get_ports {op1[63]}] [get_ports   \
{in2[0]}] [get_ports {in2[1]}] [get_ports {in2[2]}] [get_ports {in2[3]}]       \
[get_ports {in2[4]}] [get_ports {in2[5]}] [get_ports {in2[6]}] [get_ports      \
{in2[7]}] [get_ports {in2[8]}] [get_ports {in2[9]}] [get_ports {in2[10]}]      \
[get_ports {in2[11]}] [get_ports {in2[12]}] [get_ports {in2[13]}] [get_ports   \
{in2[14]}] [get_ports {in2[15]}] [get_ports {in2[16]}] [get_ports {in2[17]}]   \
[get_ports {in2[18]}] [get_ports {in2[19]}] [get_ports {in2[20]}] [get_ports   \
{in2[21]}] [get_ports {in2[22]}] [get_ports {in2[23]}] [get_ports {in2[24]}]   \
[get_ports {in2[25]}] [get_ports {in2[26]}] [get_ports {in2[27]}] [get_ports   \
{in2[28]}] [get_ports {in2[29]}] [get_ports {in2[30]}] [get_ports {in2[31]}]   \
[get_ports {in2[32]}] [get_ports {in2[33]}] [get_ports {in2[34]}] [get_ports   \
{in2[35]}] [get_ports {in2[36]}] [get_ports {in2[37]}] [get_ports {in2[38]}]   \
[get_ports {in2[39]}] [get_ports {in2[40]}] [get_ports {in2[41]}] [get_ports   \
{in2[42]}] [get_ports {in2[43]}] [get_ports {in2[44]}] [get_ports {in2[45]}]   \
[get_ports {in2[46]}] [get_ports {in2[47]}] [get_ports {in2[48]}] [get_ports   \
{in2[49]}] [get_ports {in2[50]}] [get_ports {in2[51]}] [get_ports {in2[52]}]   \
[get_ports {in2[53]}] [get_ports {in2[54]}] [get_ports {in2[55]}] [get_ports   \
{in2[56]}] [get_ports {in2[57]}] [get_ports {in2[58]}] [get_ports {in2[59]}]   \
[get_ports {in2[60]}] [get_ports {in2[61]}] [get_ports {in2[62]}] [get_ports   \
{in2[63]}] [get_ports {ww[1]}] [get_ports {ww[0]}] [get_ports sub] [get_ports  \
in_v]]
